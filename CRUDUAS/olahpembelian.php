...
if(isset($_GET['edit'])){
  ...
  $query =  mysqli_query($koneksi,"SELECT * FROM pembelian WHERE id_pembelian='$id_pembelian'");
...
<html lang="en">
  ...
  <div class="mb-3 row">
    <label for="id_detail" class="col-sm-2 col-form-label">id_pembelian</label>
    <div class="col-sm-10">
      <input type="number" class="form-control" name="id_pembelian" value="<?php echo $id_pembelian?>">
    </div>
  </div>

  <div class="mb-3 row">
    <label for="qty" class="col-sm-2 col-form-label">tanggal_pembelian</label>
    <div class="col-sm-10">
      <input type="date" class="form-control" name="tgl_pembelian" value="<?php echo $tgl_pembelian?>">>
    </div>
  </div>

  <div class="mb-3 row">
    <label for="harga" class="col-sm-2 col-form-label">pembeli_id</label>
    <div class="col-sm-10">
      <input type="number" class="form-control" name="pembeli_id" value="<?php echo $pembeli_id?>">>
    </div>
